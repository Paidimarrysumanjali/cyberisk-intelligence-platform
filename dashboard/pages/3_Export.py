# cyberrisk_platform/dashboard/pages/3_Export.py
...
# Build summary and host_summary for PDF if needed
...
with col2:
    ...
    # Ensure host_sum has the correct columns and format for export
